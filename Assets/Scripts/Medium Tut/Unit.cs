...
public class Unit
{
    ...
    {
        // remove "is Trigger" flag from box collider
        // to allow for collisions with units
        _transform.GetComponent<BoxCollider>().isTrigger = false;

        // update game resources: remove the cost
        // of the building from each game resource
